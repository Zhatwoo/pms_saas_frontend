    ...
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/45 p-4">
      <div className="w-full max-w-lg rounded-2xl border border-zinc-200 bg-white p-5 shadow-2xl">
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            <h3 className="text-base font-bold text-zinc-900">Change Avatar</h3>
            <p className="mt-1 text-xs text-zinc-500">{subtitle}</p>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="rounded-md border border-zinc-300 px-2 py-1 text-xs font-semibold text-zinc-700 transition-colors hover:bg-zinc-50"
            disabled={isSaving}
          >
            Close
          </button>
        ...
        <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-3">
          {mode === "upload" ? (
            <div className="space-y-3">
              <input
                ...
                className="block w-full text-xs text-zinc-700 file:mr-3 file:rounded-md file:border file:border-zinc-300 file:bg-white file:px-3 file:py-1.5 file:text-xs file:font-semibold file:text-zinc-700 hover:file:bg-zinc-100"
              />
              {!previewUrl && currentAvatarUrl && (
                <p className="text-[11px] text-zinc-500">Current avatar is shown below.</p>
              )}
            </div>
          ) : (
            <div className="space-y-3">
              <div className="overflow-hidden rounded-lg border border-zinc-300 bg-black">
          ...
          <div className="mt-4 flex items-center justify-center gap-4">
            <button
              ...
              className="h-24 w-24 overflow-hidden rounded-full border-4 border-white bg-zinc-200 shadow-sm disabled:cursor-not-allowed"
            ...
            <div className="flex flex-col items-center space-y-2 text-center">
              ...
              <button
                ...
                disabled={!displayImage}
                className="rounded-md border border-zinc-300 bg-white px-2.5 py-1 text-[11px] font-semibold text-zinc-700 transition-colors hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-60"
              >
                View Avatar
              </button>
            </div>
        ...
        <div className="mt-4 flex items-center justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="rounded-md border border-zinc-300 px-4 py-2 text-xs font-semibold text-zinc-700 hover:bg-zinc-50"
            disabled={isSaving}
          >
            Cancel
          </button>
