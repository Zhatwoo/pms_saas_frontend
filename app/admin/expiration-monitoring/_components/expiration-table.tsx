        ...
        if (key === "actions") {
          ...
          return (
            <div className="flex items-center justify-center gap-2">
              ...
              <button
                onClick={() => onSendEmail?.(row.id, row.customer)}
