                ...
                <div className="space-y-2">
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 rounded-lg border border-pawn-sidebar-light bg-pawn-sidebar px-3 py-2.5 text-xs font-bold text-pawn-gold transition-opacity hover:opacity-90"
                    >
