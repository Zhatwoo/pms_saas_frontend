...
interface DeleteTransactionModalProps {
  ...
  onClose: () => void;
  onConfirm: (transaction: TransactionRow) => void;
}
...
export function DeleteTransactionModal({
  ...
  async function handleConfirm() {
    ...
    const transactionToRemove = transaction;

    setIsDeleting(true);
    try {
      onConfirm(transactionToRemove);
      onClose();
    } finally {
      setIsDeleting(false);
    }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md overflow-hidden rounded-xl border border-red-200 bg-surface shadow-2xl">
