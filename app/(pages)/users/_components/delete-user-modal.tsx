...
export function DeleteUserModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative z-10 w-full max-w-sm animate-[fadeInUp_0.25s_ease-out] rounded-xl border border-red-200 bg-surface shadow-2xl overflow-hidden">
        {/* Warning Section */}
        <div className="flex flex-col items-center px-6 pt-6">
          ...
          <p className="mt-2 text-center text-xs leading-relaxed text-text-tertiary">
            ...
            <span className="font-bold text-text-primary">{userToDelete.fullName || userToDelete.email}</span>?
            This action <span className="text-red-600 font-semibold underline">cannot be undone</span> and all 
