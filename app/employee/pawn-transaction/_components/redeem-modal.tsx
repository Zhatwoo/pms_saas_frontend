                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <input 
                      ...
                      className={transactionPasswordInputClass(
                        ...
                        "h-10 rounded-lg border bg-slate-50 dark:bg-surface-secondary px-3 text-sm text-text-primary outline-none focus:ring-4 focus:ring-emerald-500/10 transition-all placeholder:text-text-muted border-emerald-100 dark:border-border-subtle focus:border-emerald-500",
                      )}
